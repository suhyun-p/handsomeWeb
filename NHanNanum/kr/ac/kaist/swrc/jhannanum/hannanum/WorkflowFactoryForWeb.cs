...
namespace kr.ac.kaist.swrc.jhannanum.hannanum
{
	...
	/// </author>
	public class WorkflowFactoryForWeb
	{
		...
		/// </returns>
		public static WorkflowForWeb getPredefinedWorkflow(int workflowFlag)
		{
			WorkflowForWeb workflow = new WorkflowForWeb();

			string chartMorphAnalyzerPath = HttpContext.Current.Server.MapPath(@"~/bin/conf/plugin/MajorPlugin/MorphAnalyzer/ChartMorphAnalyzer.json");
			string hmmPosTaggerPath = HttpContext.Current.Server.MapPath(@"~/bin/conf/plugin/MajorPlugin/PosTagger/HmmPosTagger.json");
			...
			switch (workflowFlag)
			{
				...
				case WORKFLOW_HMM_POS_TAGGER: 
					...
					workflow.setMorphAnalyzer(new kr.ac.kaist.swrc.jhannanum.plugin.MajorPlugin.MorphAnalyzer.ChartMorphAnalyzer.ChartMorphAnalyzer(), chartMorphAnalyzerPath);
					workflow.appendMorphemeProcessor(new UnknownProcessor(), null);
					
					workflow.setPosTagger(new HMMTagger(), hmmPosTaggerPath);
					break;
