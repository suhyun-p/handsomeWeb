...
namespace kr.ac.kaist.swrc.jhannanum.hannanum
{
    ...
    public class WorkflowForWeb
    {
        ...
        public WorkflowForWeb()
        {
			...
			//string webBase = HttpContext.Current.Server.MapPath(@"~/bin");
            //this.baseDir = ".";
        ...
        /// </param>
        public WorkflowForWeb(System.String baseDir)
        {
            this.maxSupplementPluginNum = MAX_SUPPLEMENT_PLUGIN_NUM;
        ...
        /// </param>
		public WorkflowForWeb(System.String baseDir, int maxSupplementPluginNum)
        {
